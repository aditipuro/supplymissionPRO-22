...
function setup() {
	...
	redBoxLeft = createSprite(300, 390, 20, 100);
	redBoxBottom = createSprite(400, 390, 200, 20);
	redBoxRight = createSprite(500, 390, 20, 100);

	redBoxLeft.color("red");
	redBoxBottom.color("red"); 
	redBoxRight.color("red");  
